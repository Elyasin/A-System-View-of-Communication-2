...
fa(2,:) = Asig(1)*cos(2*pi*ksig(1)*n/frame_length+phisig(1)) + ...
          Asig(2)*cos(2*pi*ksig(2)*n/frame_length+phisig(2));
fa(3,:) = Asig(1)*cos(2*pi*ksig(1)*n/frame_length+phisig(1)) + ...
          Asig(2)*cos(2*pi*ksig(2)*n/frame_length+phisig(2)) + ...
          Asig(3)*cos(2*pi*ksig(3)*n/frame_length+phisig(3)) + ...
          Asig(4)*cos(2*pi*ksig(4)*n/frame_length+phisig(4));
